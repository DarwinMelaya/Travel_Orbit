...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen font-questrial text-white relative flex items-center justify-center py-20">
      {/* Background slider */}
      <div
        ...
        <div className="rounded-[28px] border border-white/16 bg-white/6 backdrop-blur-[18px] shadow-[0_22px_80px_rgba(0,0,0,0.45)] p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-white/70">
              Join us and start booking your ferry trips today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <input
                  ...
                  className={`w-full rounded-[18px] border ${
                    errors.firstName
                      ? "border-red-500/50"
                      : "border-white/14"
                  } bg-white/6 p-[14px_19px] outline-none text-white/92 text-sm placeholder:text-white/50 focus:border-[rgba(16,185,129,0.5)] focus:bg-white/8 transition-all duration-200`}
                  placeholder="John"
                />
                {errors.firstName && (
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full rounded-[18px] border ${
                    errors.lastName ? "border-red-500/50" : "border-white/14"
                  } bg-white/6 p-[14px_19px] outline-none text-white/92 text-sm placeholder:text-white/50 focus:border-[rgba(16,185,129,0.5)] focus:bg-white/8 transition-all duration-200`}
                  placeholder="Doe"
                />
                {errors.lastName && (
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full rounded-[18px] border ${
                    errors.email ? "border-red-500/50" : "border-white/14"
                  } bg-white/6 p-[14px_19px] outline-none text-white/92 text-sm placeholder:text-white/50 focus:border-[rgba(16,185,129,0.5)] focus:bg-white/8 transition-all duration-200`}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`w-full rounded-[18px] border ${
                    errors.password ? "border-red-500/50" : "border-white/14"
                  } bg-white/6 p-[14px_19px] pr-[50px] outline-none text-white/92 text-sm placeholder:text-white/50 focus:border-[rgba(16,185,129,0.5)] focus:bg-white/8 transition-all duration-200`}
            ...
            <div className="flex items-start gap-2 text-sm">
              <input
                ...
                id="terms"
                required
                className="mt-1 w-4 h-4 rounded border-white/14 bg-white/6 text-[rgba(16,185,129,0.95)] focus:ring-[rgba(16,185,129,0.5)]"
              />
              <label htmlFor="terms" className="text-white/70 cursor-pointer">
                I agree to the{" "}
                <Link
                  to="#"
                  className="text-[rgba(16,185,129,0.95)] hover:text-[rgba(16,185,129,1)] transition-colors"
                >
                  Terms of Service
                </Link>{" "}
                and{" "}
